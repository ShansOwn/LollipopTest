...
import com.shansown.android.lollipoptest.photoviewer.PhotoViewerActivity;
...
public class MainActivity extends BaseActivity {
    ...
    /**
     * Launch Photo Viewer demo. Called from onclick=""
     *
     * @param unused
     */
    public void photoViewerDemo(View unused) {
        launchClass(PhotoViewerActivity.class);
    }
}
