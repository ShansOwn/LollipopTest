...
import com.shansown.android.lollipoptest.provider.LollipopTestDatabase.Tables;
import com.shansown.android.lollipoptest.util.SelectionBuilder;
...
public class LollipopTestProvider extends ContentProvider {

    private static final String TAG = makeLogTag(LollipopTestProvider.class);
    ...
    private LollipopTestDatabase mDbHelper;

    @Override
    public boolean onCreate() {
        mDbHelper = new LollipopTestDatabase(getContext());
        return true;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        // avoid the expensive string concatenation below if not loggable
        if (Log.isLoggable(TAG, Log.VERBOSE)) {
            LOGV(TAG, "uri=" + uri + ", selection=" + selection
    ...
    private void notifyChange(Uri uri) {
        ...
        if (!LollipopTestContract.hasCallerIsSyncAdapterParameter(uri)) {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        final String authority = LollipopTestContract.CONTENT_AUTHORITY;
