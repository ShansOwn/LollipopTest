...
import com.shansown.androidtests.provider.LollipopTestContract.Entry;
import com.shansown.androidtests.synctest.FeedParser;
...
import static com.shansown.androidtests.util.LogUtils.LOGE;
import static com.shansown.androidtests.util.LogUtils.LOGI;
...
public class SyncAdapter extends AbstractThreadedSyncAdapter {
  ...
  private static final String[] PROJECTION = new String[] {
      LollipopTestContract.Entry.ENTRY_ID, LollipopTestContract.Entry.ENTRY_TITLE,
      LollipopTestContract.Entry.ENTRY_LINK, LollipopTestContract.Entry.ENTRY_PUBLISHED
  };
  ...
  @Override public void onPerformSync(Account account, Bundle extras, String authority,
    ...
    final String logSanitizedAccountName =
  ...
  public void updateLocalFeedData(final InputStream stream, final SyncResult syncResult)
      throws IOException, XmlPullParserException, RemoteException, OperationApplicationException,
      ParseException {
    ...
    mContentResolver.notifyChange(Entry.CONTENT_URI,      // URI where data was modified
