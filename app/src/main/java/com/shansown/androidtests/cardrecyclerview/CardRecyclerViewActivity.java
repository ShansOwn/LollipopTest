...
public class CardRecyclerViewActivity extends BaseActivity
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    mAdapter =
        new CountryAdapter(CountryManager.getInstance().getCountries(), R.layout.list_item_card,
            this);
  ...
  private void animateAddCountryFab() {
     ...
     */
    /*Animation animation =
        AnimationUtils.loadAnimation(CardRecyclerViewActivity.this, R.anim.add_country_anim);
    mAddCountryFab.startAnimation(animation);*/
  ...
  public void onEvent(CountryEvent event) {
    ...
    switch (event.type) {
      case VIEW:
        Country country = mAdapter.getItem(position);
        CardDetailActivity.launch(this, event.countryView.findViewById(R.id.image), country,
            position);
        break;
      case DELETE:
