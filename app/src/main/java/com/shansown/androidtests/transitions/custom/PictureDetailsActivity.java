...
public class PictureDetailsActivity extends BaseActivity {
  ...
  @Override protected void onCreate(Bundle savedInstanceState) {
    ...
    String imageUrl = bundle.getString(PREFIX + ".url");
    String description = bundle.getString(PREFIX + ".description");
    final int thumbnailTop = bundle.getInt(PREFIX + ".top");
    final int thumbnailLeft = bundle.getInt(PREFIX + ".left");
    final int thumbnailWidth = bundle.getInt(PREFIX + ".width");
    final int thumbnailHeight = bundle.getInt(PREFIX + ".height");
    mOriginalOrientation = bundle.getInt(PREFIX + ".orientation");

    Picasso.with(App.getAppContext()).load(imageUrl).into(mImageView);
  ...
  public void runEnterAnimation() {
    final long duration = (long) (ANIM_DURATION * PicturesActivity.sAnimatorScale);
    ...
    ObjectAnimator colorizer =
        ObjectAnimator.ofFloat(PictureDetailsActivity.this, "saturation", 0, 1);
  ...
  public void runExitAnimation(final Runnable endAction) {
    ...
    mTextView.animate()
        .translationY(-mTextView.getHeight())
        .alpha(0)
        .setDuration(duration / 2)
        ...
        .withEndAction(() -> {
          ...
          ObjectAnimator colorizer =
              ObjectAnimator.ofFloat(PictureDetailsActivity.this, "saturation", 1, 0);
          colorizer.setDuration(duration);
          colorizer.start();
        });
  }
